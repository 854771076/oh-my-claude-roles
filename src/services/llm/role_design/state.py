...
class RoleDesignState(BaseModel):
    ...
    category: str | None = Field(None, description="Category (backend/frontend/devops etc.)")
    tags: list[str] = Field(default_factory=list, description="List of tags")
    target_domain: str | None = Field(None, description="Target domain and use case description")
    tech_stack: str | None = Field(None, description="Technology stack requirements")
    ...
    # Final output
    final_document: str | None = Field(None, description="Final formatted Markdown document")
